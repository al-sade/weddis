...
<!--                TODO: data from DB-->
				...
				<div class="photoItem__container">
					<a href="assets/img/main.jpg" class="photo__gallery__item"><!-- Link to full image -->
						<img src="assets/img/main.jpg" alt=""><!-- Link to image thumbnail -->
...
</section><!-- /Single Supplier Section -->
